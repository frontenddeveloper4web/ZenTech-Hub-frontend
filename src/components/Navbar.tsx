        ...
        <nav className="hidden md:flex gap-6 items-center">
          {["home", "about", "courses", "mentor", "faqs", "contact"].map((id, i) => (
            <button
              ...
              className="capitalize text-gray-700 hover:text-[#0B2C7D] cursor-pointer transition"
            >
              {id === "mentor" ? "Become a Mentor/Ambassador" : id.replace("-", " ")}
            </button>
          ))}
          <button className="ml-4 bg-[#0B2C7D] hover:bg-[#0b2b7de3] text-white px-4 py-2 rounded-md shadow">
            Get Started
          </button>
        </nav>
      </div>
